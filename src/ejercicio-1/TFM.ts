...
/**
 * Representa un Trabajo de Fin de Máster (TFM).
 *  
...
export class TFM extends ElementoBibliografico {
  ...
  /**
   * Crea una instancia de un trabajo de fin de máster.
   * 
  ...
  toIEEE(): string {
    return `${this.autores.join(", ")}, "${this.titulo}," Master thesis, ${this.universidad},  ${this.fechaPublicacion.toISOString().split("T")[0]}.`;
  }
}